...
void model_state_table_del(struct model_state_table* table, unsigned long iter)
{
    ...
    {
        if (model_state_table_exist(table, i)) {
            struct model_trans_table* tbl =
                model_state_get_mtrans_table(model_state_table_get(table, i));
...
unsigned long model_state_table_find(struct model_state_table const* table,
