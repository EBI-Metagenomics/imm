...
HIDE struct mm_state *mm_state_find(struct mm_state *head, const struct imm_state *state);
HIDE const struct mm_state *mm_state_find_c(const struct mm_state *head,
