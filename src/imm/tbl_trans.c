...
double tbl_trans_get_lprob(const struct tbl_trans *tbl_trans) { return tbl_trans->lprob; }

struct tbl_trans *tbl_trans_next(struct tbl_trans *tbl_trans) { return tbl_trans->hh.next; }
