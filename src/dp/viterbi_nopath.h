...
void viterbi_nopath_row0(struct imm_dp const *, struct imm_task *,
                         unsigned unsafe_state);

void viterbi_nopath(struct imm_dp const *, struct imm_task *,
                    struct imm_range const *, unsigned unsafe_state);

void viterbi_nopath_safe_row0(struct imm_dp const *, struct imm_task *,
                              unsigned unsafe_state);
