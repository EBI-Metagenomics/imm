...
static inline uint_fast8_t   dp_state_table_max_seq(struct dp_state_table const* state_tbl, uint_fast16_t state);
static inline uint_fast8_t   dp_state_table_min_seq(struct dp_state_table const* state_tbl, uint_fast16_t state);
...
static inline imm_float      dp_state_table_start_lprob(struct dp_state_table const* state_tbl, uint_fast16_t state);
