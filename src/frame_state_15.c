...
//
// p(T=ddnn) = e^2 * (1-e)^2
imm_float imm_joint_n1_15(struct imm_frame_state const *state,
...
imm_float imm_joint_n2_15(struct imm_frame_state const *state,
                          struct imm_seq const *seq)
{
    struct imm_abc const *abc = imm_super(state->codonm->nuclt);
...
//           = e^2 * (1-e)^2
// p(T=ddii) = e^4 * (1-e)^0
imm_float imm_joint_n3_15(struct imm_frame_state const *state,
                          struct imm_seq const *seq)
{
    struct imm_abc const *abc = imm_super(state->codonm->nuclt);
...
imm_float imm_joint_n4_15(struct imm_frame_state const *state,
                          struct imm_seq const *seq)
{
    struct imm_abc const *abc = imm_super(state->codonm->nuclt);
...
//
// p(T=nnii) = e^2 * (1-e)^2
imm_float imm_joint_n5_15(struct imm_frame_state const *state,
                          struct imm_seq const *seq)
{
    struct imm_abc const *abc = imm_super(state->codonm->nuclt);
