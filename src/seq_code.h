...
IMM_EXPORT struct seq_code const* seq_code_create(struct imm_abc const* abc,
                                                      unsigned min_seq, unsigned max_seq);
IMM_EXPORT unsigned seq_code_encode(struct seq_code const* seq_code, unsigned min_seq,
                                        struct imm_seq const* seq);
IMM_EXPORT struct eseq const* seq_eseq(struct seq_code const* seq_code,
                                           struct imm_seq const*  seq);
