...
static inline uint_fast16_t         seq_code_offset(struct seq_code const* seq_code, unsigned min_seq);
struct seq_code const*              seq_code_read(FILE* stream, struct imm_abc const* abc);
static inline uint_fast16_t         seq_code_size(struct seq_code const* seq_code, unsigned min_seq);
...
static inline unsigned seq_code_max_seq(struct seq_code const* seq_code) { return seq_code->max_seq; }

static inline unsigned seq_code_min_seq(struct seq_code const* seq_code) { return seq_code->min_seq; }
