...
#define MAKE_MATRIX_CREATE(NAME, T)                                            \
    static inline struct NAME *NAME##_create(uint_fast32_t const nrows,        \
                                             uint_fast32_t const ncols)        \
    {                                                                          \
...
#define MAKE_MATRIX_GET(NAME, T)                                               \
    static inline T NAME##_get(struct NAME const *matrix, uint_fast32_t r,     \
                               uint_fast32_t c)                                \
    {                                                                          \
...
#define MAKE_MATRIX_GET_PTR(NAME, T)                                           \
    static inline T *NAME##_get_ptr(struct NAME const *matrix,                 \
                                    uint_fast32_t r, uint_fast32_t c)          \
    {                                                                          \
        return matrix->data + (r * matrix->ncols + c);                         \
    }
...
#define MAKE_MATRIX_SET(NAME, T)                                               \
    static inline void NAME##_set(struct NAME *matrix, uint_fast32_t r,        \
                                  uint_fast32_t c, T v)                        \
    {                                                                          \
...
#define MAKE_MATRIX_NROWS(NAME)                                                \
    static inline uint_fast32_t NAME##_nrows(struct NAME const *matrix)        \
    {                                                                          \
        return matrix->nrows;                                                  \
    }

#define MAKE_MATRIX_NCOLS(NAME)                                                \
    static inline uint_fast32_t NAME##_ncols(struct NAME const *matrix)        \
    {                                                                          \
        return matrix->ncols;                                                  \
    }

#define MAKE_MATRIX_RESIZE(NAME, T)                                            \
    static inline int NAME##_resize(struct NAME *matrix,                       \
                                    uint_fast32_t const nrows,                 \
                                    uint_fast32_t const ncols)                 \
    {                                                                          \
