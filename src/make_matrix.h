...
#define MAKE_MATRIX_GET_PTR_C(NAME, T)                                                             \
    static inline T const* NAME##_get_ptr_c(struct NAME const* matrix, uint_fast32_t r,            \
                                            uint_fast32_t c)                                       \
    {                                                                                              \
        return matrix->data + (r * matrix->ncols + c);                                             \
    }
...
#define MAKE_MATRIX_RESIZE(NAME, T)                                                                \
    static inline void NAME##_resize(struct NAME* matrix, uint_fast32_t const nrows,               \
