...
IMM_API int imm_seq_table_add(struct imm_seq_table* table, struct imm_seq const* seq, double lprob);
...
IMM_API double  imm_seq_table_lprob(struct imm_seq_table const* table, struct imm_seq const* seq);
