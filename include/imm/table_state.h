...
/* IMM_API struct imm_state *imm_table_state_cast(struct imm_state *state); */
/* IMM_API const struct imm_state *imm_table_state_cast_c(const struct imm_state *state); */
