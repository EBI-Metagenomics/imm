...
IMM_EXPORT struct imm_state const*      imm_mute_state_parent(struct imm_mute_state const* state);
IMM_EXPORT struct imm_mute_state const* imm_mute_state_child(struct imm_state const* state);
