...
IMM_API struct imm_model* imm_model_create(struct imm_hmm* hmm, struct imm_dp* dp);
...
IMM_API struct imm_state* imm_model_state(struct imm_model const* model, uint16_t i);
