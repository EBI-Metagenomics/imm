...
IMM_API imm_float       imm_hmm_get_trans(struct imm_hmm const* hmm, struct imm_state const* src,
...
IMM_API int             imm_hmm_normalize_state_trans(struct imm_hmm const* hmm, struct imm_state* src);
IMM_API int             imm_hmm_set_start(struct imm_hmm* hmm, struct imm_state const* state, imm_float lprob);
IMM_API int imm_hmm_set_trans(struct imm_hmm* hmm, struct imm_state* src, struct imm_state const* dst, imm_float lprob);
