...
IMM_API imm_float imm_hmm_get_start(struct imm_hmm const *hmm,
                                    struct imm_state const *state);
IMM_API imm_float imm_hmm_get_trans(struct imm_hmm const *hmm,
                                    struct imm_state const *src,
                                    struct imm_state const *dst);
IMM_API imm_float imm_hmm_loglikelihood(struct imm_hmm const *hmm,
