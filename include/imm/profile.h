...
IMM_API void                      imm_profile_append_hmm_block(struct imm_profile* prof, struct imm_hmm_block* block);
IMM_API struct imm_hmm_block*     imm_profile_get_hmm_block(struct imm_profile const* prof, uint8_t i);
IMM_API uint8_t                   imm_profile_nhmm_blocks(struct imm_profile const* prof);
...
IMM_API int                 __imm_profile_read_hmm_blocks(struct imm_profile* prof, FILE* stream);
IMM_API int                 __imm_profile_write_hmm_blocks(struct imm_profile const* prof, FILE* stream);
