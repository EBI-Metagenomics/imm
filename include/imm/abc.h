...
IMM_API unsigned              imm_abc_length(struct imm_abc const* abc);
IMM_API char const*           imm_abc_symbols(struct imm_abc const* abc);
IMM_API bool                  imm_abc_has_symbol(struct imm_abc const* abc, char symbol_id);
IMM_API int                   imm_abc_symbol_idx(struct imm_abc const* abc, char symbol_id);
IMM_API char                 imm_abc_symbol_id(struct imm_abc const* abc, unsigned symbol_idx);
