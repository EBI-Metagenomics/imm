...
IMM_EXPORT struct imm_results* imm_results_create(struct imm_seq const* seq, unsigned nresults);
...
IMM_EXPORT struct imm_result const* imm_results_get(struct imm_results const* results,
                                                    unsigned                  idx);
IMM_EXPORT void imm_results_set(struct imm_results* results, unsigned idx, struct imm_subseq subseq,
