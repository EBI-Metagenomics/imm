...
IMM_TEMPLATE struct imm_ctrans const *g9999_safe_states_fixed(
...
IMM_TEMPLATE struct imm_ctrans const *g9999_safe_states_unfixed(
...
IMM_TEMPLATE void g9999(struct imm_hot_range const *hot,
                        struct imm_viterbi const *x, unsigned const row,
...
viterbi_g0015(struct imm_hot_range hot, struct imm_viterbi const *x,
              unsigned const seqlen, struct unsafe unsafe,
              struct imm_dp_safety const *y, bool const save_path)
{
