...
void test_path(void)
{
    ...
    struct imm_normal_state const* state0 = imm_normal_state_create(0, "State0", abc, lprobs);
    struct imm_normal_state const* state1 = imm_normal_state_create(1, "State1", abc, lprobs);
