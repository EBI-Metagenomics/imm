...
void test_hmm_write_io_two_hmms(void)
{
    ...
    struct imm_mute_state*   hmm0_state0 = imm_mute_state_create(0, "hmm0_state0", abc);
    imm_float                hmm0_lprobs[] = {imm_log(0.25), imm_log(0.25), imm_log(0.5), zero()};
    struct imm_normal_state* hmm0_state1 = imm_normal_state_create(1, "hmm0_state1", abc, hmm0_lprobs);
    ...
    struct imm_normal_state* hmm1_state1 = imm_normal_state_create(3, "", abc, hmm1_lprobs);
