...
void test_hmm_write_io_two_hmms(void)
{
    ...
    imm_float hmm1_lprobs[] = {imm_log(0.25f), imm_log(0.25f), imm_log(0.5), zero()};
    ...
    imm_hmm_add_state(hmm1, imm_normal_state_super(hmm1_state1), imm_log(0.001f));
    ...
    struct imm_dp const* dp1 = imm_hmm_create_dp(hmm0, imm_normal_state_super(hmm1_state1));
