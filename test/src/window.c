...
void test_window_0(void)
{
    ...
    struct imm_window const* window = imm_window_create(seq, 0);
    cass_cond(window != NULL);
    cass_cond(imm_window_size(window) == 1);

    struct imm_subseq subseq = imm_window_get(window, 0);
...
void test_window_1(void)
{
    ...
    struct imm_window const* window = imm_window_create(seq, 1);
    cass_cond(window != NULL);
    cass_cond(imm_window_size(window) == 1);
...
void test_window_3(void)
{
    ...
    subseq = imm_window_get(window, 1);
    cass_cond(imm_seq_length(imm_subseq_cast(&subseq)) == 1);
...
void test_window_4(void)
{
    ...
    subseq = imm_window_get(window, 2);
    cass_cond(imm_seq_length(imm_subseq_cast(&subseq)) == 1);
...
void test_window_5(void)
{
    ...
    struct imm_window const* window = imm_window_create(seq, 2);
...
void test_window_6(void)
{
    ...
    struct imm_window const* window = imm_window_create(seq, 3);
...
void test_window_7(void)
{
    ...
    struct imm_window const* window = imm_window_create(seq, 4);
...
void test_window_11(void)
{
    ...
    subseq = imm_window_get(window, 3);
    cass_cond(imm_seq_length(imm_subseq_cast(&subseq)) == 2);
...
void test_window_14(void)
{
    ...
    struct imm_window const* window = imm_window_create(seq, 5);
...
void test_window_15(void)
{
    ...
    struct imm_window const* window = imm_window_create(seq, 6);
