...
void test_hmm_state_id(void)
{
    ...
    cass_cond(imm_hmm_add_state(hmm, imm_mute_state_super(state), log(1.0)) == 0);
    cass_cond(imm_hmm_add_state(hmm, imm_mute_state_super(state), log(1.0)) == 1);
...
void test_hmm_del_get_state(void)
{
    ...
    cass_cond(imm_hmm_add_state(hmm, imm_mute_state_super(state0), log(0.5)) == 0);
    cass_cond(imm_hmm_add_state(hmm, imm_mute_state_super(state1), log(0.5)) == 0);
...
void test_hmm_set_trans(void)
{
    ...
    imm_hmm_add_state(hmm, imm_mute_state_super(state1), log(0.5));
...
void test_hmm_wrong_states(void)
{
    ...
    imm_hmm_add_state(hmm, imm_mute_state_super(state0), log(0.5));
    cass_equal_int(imm_hmm_set_start(hmm, imm_mute_state_super(state1), log(0.3)), 1);
    cass_equal_int(imm_hmm_set_trans(hmm, imm_mute_state_super(state0),
                                     imm_mute_state_super(state1), log(0.3)),
                   1);
    cass_equal_int(imm_hmm_set_trans(hmm, imm_mute_state_super(state1),
                                     imm_mute_state_super(state0), log(0.3)),
                   1);
    cass_cond(imm_hmm_create_dp(hmm, imm_mute_state_super(state1)) == NULL);
    cass_equal_int(imm_hmm_normalize_trans(hmm, imm_mute_state_super(state1)), 1);
    cass_equal_int(imm_hmm_normalize_trans(hmm, imm_mute_state_super(state0)), 0);
