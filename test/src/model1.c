...
struct model1 create_model1(void)
{
    ...
    struct model1 m = {.hmm = NULL, .abc = NULL, .mute_states = imm_vecp_create(), .normal_states = imm_vecp_create()};
    ...
    imm_float end_lprobs[] = {imm_log(0.05), imm_log(0.05), imm_log(0.05), imm_log(0.05), imm_log(0.05)};
    ...
    imm_hmm_set_trans(hmm, normal_super(E), normal_super(end), imm_log(0.2));
    imm_hmm_set_trans(hmm, normal_super(end), normal_super(end), imm_log(0.2));
