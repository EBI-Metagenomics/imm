...
void test_seq_code1(void)
{
    ...
    cass_equal_uint64(seq_code_encode(seq_code, min_seq, seq), 0);
    imm_seq_destroy(seq);

    seq = imm_seq_create("A", abc);
    cass_equal_uint64(seq_code_encode(seq_code, min_seq, seq), 1);
    imm_seq_destroy(seq);

    seq = imm_seq_create("T", abc);
    cass_equal_uint64(seq_code_encode(seq_code, min_seq, seq), 3);
    imm_seq_destroy(seq);

    seq = imm_seq_create("AA", abc);
    cass_equal_uint64(seq_code_encode(seq_code, 2, seq), 0);
    imm_seq_destroy(seq);

    seq = imm_seq_create("TA", abc);
    cass_equal_uint64(seq_code_encode(seq_code, 2, seq), 6);
    imm_seq_destroy(seq);
...
void test_seq_code2(void)
{
    ...
    cass_equal_uint64(seq_code_encode(seq_code, min_seq, seq), 15);
    imm_seq_destroy(seq);

    seq = imm_seq_create("AAA", abc);
    cass_equal_uint64(seq_code_encode(seq_code, min_seq, seq), 16);
    imm_seq_destroy(seq);

    seq = imm_seq_create("AAA", abc);
    cass_equal_uint64(seq_code_encode(seq_code, 3, seq), 0);
    imm_seq_destroy(seq);

    seq = imm_seq_create("TTT", abc);
    cass_equal_uint64(seq_code_encode(seq_code, min_seq, seq), 79);
    imm_seq_destroy(seq);

    seq = imm_seq_create("TTT", abc);
    cass_equal_uint64(seq_code_encode(seq_code, 3, seq), 63);
    imm_seq_destroy(seq);

    seq = imm_seq_create("TTTT", abc);
    cass_equal_uint64(seq_code_encode(seq_code, min_seq, seq), 335);
    imm_seq_destroy(seq);
