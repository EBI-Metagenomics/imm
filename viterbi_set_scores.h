...
IMM_TEMPLATE void
viterbi_set_scores_single(struct imm_viterbi const *x, unsigned const row,
                          uint_fast16_t const dst, uint_fast8_t const min,
...
IMM_TEMPLATE void viterbi_set_scores_xy(struct imm_viterbi const *x,
                                        unsigned const row,
...
IMM_TEMPLATE void viterbi_set_scores_15(struct imm_viterbi const *x,
                                        unsigned const row,
...
IMM_TEMPLATE void viterbi_set_scores_11(struct imm_viterbi const *x,
                                        unsigned const row,
                                        uint_fast16_t const dst,
                                        float const score)
{
...
IMM_TEMPLATE void viterbi_set_scores_00(struct imm_viterbi const *x,
                                        unsigned const row,
                                        uint_fast16_t const dst,
                                        float const score)
{
